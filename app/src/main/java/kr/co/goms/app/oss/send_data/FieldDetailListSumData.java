 ...
 * 맨홀조사야장 상세 리스트 가져오기
 */
public class FieldDetailListSumData extends SendData implements ISendData{
    private final String TAG = FieldDetailListSumData.class.getSimpleName();
    @Override
    public void onSendData() {
        GomsLog.d(TAG, FieldDetailListSumData.class.getSimpleName() + " >>>> onSendStempData()");

        mParserType = GsonManager.PARSER_TYPE.fieldDetailListSum;
    ...
    private void successData(Object object){
        ...
        baseBean.setObject(((FieldDetailListSumBeanG) object).getRes_data());
