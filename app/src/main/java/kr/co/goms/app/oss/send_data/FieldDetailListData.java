 ...
 * 맨홀조사야장 상세 리스트 가져오기
 */
public class FieldDetailListData extends SendData implements ISendData{
    private final String TAG = FieldDetailListData.class.getSimpleName();
    @Override
    public void onSendData() {
        GomsLog.d(TAG, FieldDetailListData.class.getSimpleName() + " >>>> onSendStempData()");

        mParserType = GsonManager.PARSER_TYPE.fieldDetailList;
